...
const Services = () => {
    useEffect(() => {
        document.title="SabirSolutions | Services";
    },[]);
  ...
  return (
    <>
        ...
        <div className="bg-gradient-to-br from-blue-100">
            ...
            <div className="xl:px-20 px-6 py-20 xl:mx-auto xl:container">
                ...
                <div className="md:mt-14 mt-4 relative sm:flex items-center justify-center">
                    ...
                    ref={ref}
                            ...
                            transition={{ duration: 1, delay: 0.25 }} className="shadow-lg xl:p-6 p-4 sm:w-auto w-full bg-white sm:absolute relative z-0  mt-4 left-0 xl:ml-56 sm:ml-12 xl:-mt-40 sm:-mt-12">
                    ...
                    ref={ref}
                            ...
                            initial="hidden"
                            animate={mainControlls}
                            transition={{ duration: 1, delay: 0.25 }} className="shadow-lg xl:p-6 p-4 sm:w-auto w-full bg-white sm:absolute relative z-0 sm:mt-0 mt-4 xl:mt-80  xl:-ml-0 sm:-ml-12">
                    ...
                    ref={ref}
                            ...
                            initial="hidden"
                            animate={mainControlls}
                            transition={{ duration: 1, delay: 0.25 }} className="shadow-lg xl:p-6 p-4 sm:w-auto w-full bg-white sm:absolute relative z-0 md:mt-0 sm:-mt-5 mt-4 right-0 xl:mr-56 sm:mr-24">
            ...
            <div className="w-[70%] h-[3px] bg-gradient-to-r from-blue-400 to-violet-500"></div>
